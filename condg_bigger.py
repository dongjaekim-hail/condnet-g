...
def main():
    ...
    args.add_argument('--lambda_s', type=float, default=15)
    ...
    wandb.init(project="condg_mlp_dk22",
                entity="hails",
                config=args.__dict__,
                name='condg_bigger_mlp_s=' + str(args.lambda_s) + '_v=' + str(args.lambda_v) + '_tau=' + str(args.tau)
                )
    ...
    for epoch in range(max_epochs):
        ...
        for i, data in enumerate(train_loader, 0):
            ...
            L = c + lambda_v * Lv_ + lambda_s * (Lb_ + Le_)
            ...
            wandb.log({'train/batch_cost': c.item(), 'train/batch_acc': acc, 'train/batch_acc_bf': accbf, 'train/batch_pg': PG.item(), 'train/batch_loss': L.item(), 'train/batch_tau': tau_, 'train/batch_Lb': Lb_, 'train/batch_Lv': Lv_})
