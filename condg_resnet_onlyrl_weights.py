...
class runtime_pruner(L.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.resnet.eval()  # ResNet은 항상 평가 모드로 유지
    ...
    #     avg_time_gnn_forward = np.mean(self.e_time_gnn_forward)
    #     avg_time_resnet_pruned_forward = np.mean(self.e_time_resnet_pruned_forward)
    #     avg_time_loss_backward = np.mean(self.e_time_loss_backward)
    #     avg_time_resnet_opt_step = np.mean(self.e_time_resnet_opt_step)
    #     avg_time_gnn_opt_step = np.mean(self.e_time_gnn_opt_step)
    #
    #     print("Training finished - Average Times:")
    #     print(f"ResNet Surrogate Forward: {avg_time_resnet_eval:.4f} seconds")
    #     print(f"GNN Forward: {avg_time_gnn_forward:.4f} seconds")
    #     print(f"ResNet Pruned Forward: {avg_time_resnet_pruned_forward:.4f} seconds")
    #     print(f"Loss Backward: {avg_time_loss_backward:.4f} seconds")
    #     print(f"ResNet Optimizer Step: {avg_time_resnet_opt_step:.4f} seconds")
    #     print(f"GNN Optimizer Step: {avg_time_gnn_opt_step:.4f} seconds")
    #
    #     wandb.log({
    #         'avg_time/resnet_eval': avg_time_resnet_eval,
    #         'avg_time/gnn_forward': avg_time_gnn_forward,
    #         'avg_time/resnet_pruned_forward': avg_time_resnet_pruned_forward,
    #         'avg_time/loss_backward': avg_time_loss_backward,
    #         'avg_time/resnet_opt_step': avg_time_resnet_opt_step,
    #         'avg_time/gnn_opt_step': avg_time_gnn_opt_step
    #     })
...
def main():
    ...
    # Print and log average times after training
    # model.on_fit_end()
