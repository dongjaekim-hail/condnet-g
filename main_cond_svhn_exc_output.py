...
def main():
    ...
    wandb.init(project="condgnet",
                ...
                name='cond_svhn_exc_output' + '_tau=' + str(args.tau)
                )
    ...
    for epoch in range(max_epochs):
        ...
        torch.save(model.state_dict(), './cond1024_svhn_excout_'+ 's=' + str(args.lambda_s) + '_v=' + str(args.lambda_v) + '_tau=' + str(args.tau) + dt_string +'.pt')
    wandb.finish()
